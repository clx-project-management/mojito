...
// Returns the private 'App\Repository\IssueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IssueRepository.php';

return $this->privates['App\\Repository\\IssueRepository'] = new \App\Repository\IssueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
